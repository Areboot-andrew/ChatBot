...
- **Прайси**: xlsx-імпорт з preview + інлайн-редагування; шаблон для скачування
- **Товари**: xlsx-імпорт (sku, назва, бренд, модель, специфікації, сумісність, ціна, наявність) + ручна картка
- Спільне: пошук по всіх типах "що знає бот про X" — дебаг-інструмент адміна

### 9.4 TODO (доповнення до M3/M4)
