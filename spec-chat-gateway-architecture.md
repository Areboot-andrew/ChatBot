...
---
## ⚠️ АБСОЛЮТНЕ ПРАВИЛО ПРОЕКТУ ДЛЯ РОЗРОБНИКІВ/ШІ ⚠️
1. **НІЯКОГО ХАРДКОДУ В ПРОМПТАХ ТА ІНСТРУКЦІЯХ!** Взагалі. Всі текстові правила, повідомлення, промпти, роздільники (headers) для LLM повинні зберігатися в Базі Даних (у полях `BotSetting` або JSONB `meta`) та редагуватися через Адмін-панель.
2. Система повинна бути **100% Multi-Tenant**. Вона має вміти одночасно обслуговувати СТО та Квітковий Магазин, не пересікаючись. 
3. Якщо ви створюєте нову фічу з текстом або правилом — **ОБОВ'ЯЗКОВО** одразу виводьте його в UI адмінки.
4. **УСІ СИСТЕМНІ ПРОМПТИ ПИШУТЬСЯ ВИКЛЮЧНО АНГЛІЙСЬКОЮ МОВОЮ** для економії токенів і кращої роботи логіки LLM. Вимога до бота "відповідати українською" прописується всередині англійського промпта.
---
