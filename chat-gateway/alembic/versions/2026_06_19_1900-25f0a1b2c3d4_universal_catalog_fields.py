"""Universal catalog fields and route prompt refresh.

Revision ID: 25f0a1b2c3d4
Revises: 24f0a1b2c3d4
...
revision = "25f0a1b2c3d4"
down_revision = "24f0a1b2c3d4"
branch_labels = None
depends_on = None


BACKUP_KEY = "_backup_2026_06_19_universal_catalog_fields"
...
def upgrade() -> None:
    ...
    conn.execute(
        sa.text(
            ...
            SET meta = (
                CASE
                    WHEN meta ? 'composition' AND NOT meta ? 'work_scope'
                    THEN jsonb_set(meta, '{work_scope}', meta->'composition')
